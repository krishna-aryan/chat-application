...
const Sidebar = () => {
  ...
  // Combined handler for cleaner JSX
  ...
  return (
    <div className={`bg-[#8185B2]/5 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUser ? 'max-md:hidden' : ''}`}> 
      ...
      <div className='flex flex-col gap-2'>
        {filteredUsers.map((user, index) => (
          ...
          >
            ...
            {/* Check if count is greater than 0 before showing bubble */}
